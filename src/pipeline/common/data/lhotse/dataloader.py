...
from pipeline.common.data.lhotse.cutset import read_cutset_from_config
...
def get_lhotse_dataloader_from_config(
    ...
    """
    print("We will be using a Lhotse DataLoader.")
    ...
    if config.channel_selector is not None:
        print('Using channel selector %s.', config.channel_selector)
    ...
    if config.use_multimodal_sampling:
        ...
        from pipeline.asr.data.audio_to_text_lhotse import TokenizerWrapper
