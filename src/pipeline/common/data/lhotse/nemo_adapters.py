...
from pipeline.common.preprocessing.manifest import get_full_path
...
def expand_sharded_filepaths(path: str | Path) -> list[str]:
    ...
    from pipeline.asr.data.audio_to_text import expand_sharded_filepaths as _expand_sharded_filepaths
