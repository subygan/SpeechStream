...
from pipeline.core_classes.adapter_mixin_strategies import AbstractAdapterStrategy


class AdapterModuleUtil(AccessMixin):
    """
    Base class of Adapter Modules, providing common functionality to all Adapter Modules.
    """

    def setup_adapter_strategy(self, adapter_strategy: Optional[AbstractAdapterStrategy]):
        """
