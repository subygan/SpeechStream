...
from pipeline.neural_types import LabelsType, LogitsType, LogprobsType, LossType, MaskType, NeuralType
...
class CrossEntropyLoss(nn.CrossEntropyLoss, Serialization, Typing):
    ...
    def __init__(self, logits_ndim=2, weight=None, reduction='mean', ignore_index=-100):
        ...
        if weight is not None and not torch.is_tensor(weight):
            ...
            print(f"Weighted Cross Entropy loss with weight {weight}")
