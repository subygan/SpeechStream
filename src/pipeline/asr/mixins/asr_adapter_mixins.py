...
from pipeline.core_classes.adapter_mixins import AdapterModelPTMixin, AdapterModuleMixin
    ...
    def check_valid_model_with_adapter_support_(self):
        ...
        if use_joint_adapter:
            ...
            if hasattr(self, 'joint') and not isinstance(self.joint, AdapterModuleMixin):
                print(
                    f'{self.joint.__class__.__name__} does not implement `AdapterModuleMixin`')
