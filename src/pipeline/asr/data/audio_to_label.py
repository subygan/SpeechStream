...
from pipeline.asr.data.audio_to_text import cache_datastore_manifests, expand_sharded_filepaths
...
from pipeline.common.preprocessing import collections
from pipeline.core_classes.dataset import Dataset, IterableDataset
from pipeline.neural_types import AudioSignal, LabelsType, LengthsType, NeuralType, RegressionValuesType
...
class AudioToSpeechLabelDataset(_AudioLabelDataset):
    ...
    def __init__(
        ...
        *,
        ...
        print("Window/slice length considered for collate func is {}".format(self.window_length_in_sec))
        print("Shift length considered for collate func is {}".format(self.shift_length_in_sec))
...
class _TarredAudioLabelDataset(IterableDataset):
    ...
    even split among workers. If it is not divisible, print() a warning but training will proceed.
...
class TarredAudioToSpeechLabelDataset(_TarredAudioLabelDataset):
    ...
    def __init__(
        ...
        *,
        ...
        print("Window/slice length considered for collate func is {}".format(window_length_in_sec))
        print("Shift length considered for collate func is {}".format(shift_length_in_sec))
        self.window_length_in_sec = window_length_in_sec
        self.shift_length_in_sec = shift_length_in_sec
        self.normalize_audio = normalize_audio
