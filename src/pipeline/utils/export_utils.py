...
def replace_MatchedScaleMaskSoftmax(n: nn.Module) -> Optional[nn.Linear]:
    ...
    from pipeline.asr.submodules.fused_softmax import MatchedScaleMaskSoftmax
...
def add_casts_around_norms(model: nn.Module):
    ...
    """
    from pipeline.asr.submodules.masked_instance_norm import MaskedInstanceNorm1d
