...
class AudioText(_Collection):
    ...
    def __init__(
        ...
        print("Dataset loaded with %d files totalling %.2f hours", len(data), total_duration / 3600)
        print("%d files were filtered totalling %.2f hours", num_filtered, duration_filtered / 3600)
...
class SpeechLabel(_Collection):
    ...
    def __init__(
        ...
        print(f"Filtered duration for loading collection is {duration_filtered / 3600: .2f} hours.")
        print(f"Dataset loaded with {len(data)} items, total duration of {total_duration / 3600: .2f} hours.")
        self.uniq_labels = sorted(set(map(lambda x: x.label, data)))
        print("# {} files loaded accounting to # {} labels".format(len(data), len(self.uniq_labels)))
...
class FeatureSequenceLabel(_Collection):
    ...
    def __init__(
        ...
        print("# {} files loaded including # {} unique labels".format(len(data), len(self.uniq_labels)))
        super().__init__(data)
...
class DiarizationLabel(_Collection):
    ...
    def __init__(
        ...
        print(f"Total {len(data)} session files loaded accounting to # {len(audio_files)} audio clips")
...
class FeatureLabel(_Collection):
    ...
    def __init__(
        ...
        print(f"Filtered duration for loading collection is {duration_filtered / 2600:.2f} hours.")
        print(f"Dataset loaded with {len(data)} items, total duration of {total_duration / 3600: .2f} hours.")
        print("# {} files loaded including # {} unique labels".format(len(data), len(self.uniq_labels)))
        super().__init__(data)
